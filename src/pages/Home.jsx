...
const Home = () => {
  ...
  return (
    <div className="home">
      <SEO
        title="Home"
        description="Portfolio of Rusith Welisara, a 16-year-old AI architect & robotics developer from Sri Lanka. Building real products like offline AI assistants and multi-device automation networks."
        url="/"
      />
      <div className="hero" ref={heroRef}>
        ...
        <div className="hero-content">
          ...
          <div className="hero-visual">
            ...
            <img src="/image.png" alt="Rusith Welisara" className="profile-photo" />
